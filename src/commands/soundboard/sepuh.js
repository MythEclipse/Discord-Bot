...
module.exports = async (client, interaction, args) => {
    ...
    client.soundboard(interaction.guild.id, interaction, "https://www.myinstants.com/media/sounds/sepuh.mp3");

    client.succNormal({ text: "Soundboard started! Playing **sepuh**", type: 'editreply' }, interaction);
};